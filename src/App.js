					...
					<div className="App">
						...
						<main className="main">
							...
							<div className="container">
								...
								<Switch>
									<PrivateRoute exact path="/commands/:id" component={CommandItem} />
								</Switch>
								<Switch>
									<PrivateRoute exact path="/player/:id" component={EditCommandPlayer} />
								</Switch>
								<Switch>
									<PrivateRoute exact path="/commands/player/add" component={AddCommandPlayer} />
								</Switch>
								<Switch>
								...
								<Switch>
									<PrivateRoute exact path="/appointgame/:id" component={AppointGame} />
								</Switch>
								<Switch>
								...
								<Switch>
									<PrivateRoute exact path="/in-progress" component={InProgress} />
								</Switch>
								<Switch>
									<PrivateRoute exact path="/cities" component={Location} />
								</Switch>
								<Switch>
									<PrivateRoute exact path="/tournaments/:id" component={Tournaments} />
								</Switch>
								<Switch>
									<PrivateRoute exact path="/subtournaments/:id" component={SubTournaments} />
								</Switch>
								<Switch>
									<PrivateRoute exact path="/subtourinfo/:id" component={InfoSubTour} />
								</Switch>
								<Switch>
