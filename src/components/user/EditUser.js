...
class EditUser extends Component {
	...
	componentWillReceiveProps(nextProps) {
		...
		if (nextProps.users.user !== null && nextProps.common.countries !== null && nextProps.lang.locale !== null) {
			...
			this.setState({
				...
				league: user.league,
				locale: user.locale,
				country: countries.filter((countryItem) => countryItem.iso === user.locale.toUpperCase())[0].name,
				lang: lang
			});
		}
	}
...
export default compose(
	withStyles(styles),
	connect(mapStateToProps, { editUser, getLeagues, getUser, getCountries, setLanguage })
)(EditUser);
