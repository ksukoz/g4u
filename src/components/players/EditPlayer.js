...
import { getPlayer, getPositions, updatePlayer, separatePlayer } from '../../actions/playerActions';
...
class EditPlayer extends Component {
	...
	componentWillReceiveProps(nextProps) {
		let player;
		let positions;
		if (nextProps.players.player !== null && nextProps.players.positions !== null) {
			...
			this.setState({
				...
				position_id: positions.filter((positionItem) => positionItem.type === player.position)[0].position_id,
				leg: player.leg,
			...
			<div className={classes.root}>
				...
				<div className={classes.form}>
					<form className="player__form" onSubmit={this.onSubmitHandler}>
						...
						<Button size="large" type="button" className={classes.button} onClick={this.onClickHandler}>
...
export default compose(
	withStyles(styles),
	connect(mapStateToProps, { getPlayer, getPositions, updatePlayer, separatePlayer })
)(EditPlayer);
