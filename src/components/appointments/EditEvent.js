...
class EditEvent extends Component {
  ...
  componentWillReceiveProps = nextProps => {
    if (nextProps.errors || nextProps.messages) {
      ...
      nextProps.games.currentGame !== null &&
      nextProps.games.event !== null
    ) {
      this.setState({
        ...this.state,
        currentGame: nextProps.games.currentGame,
        command: +nextProps.games.event.command_id,
...
export default compose(
  ...
  connect(
    mapStateToProps,
    { getCurrentGame, getEventSettings, editGameEvent, getEvent }
  )
)(EditEvent);
