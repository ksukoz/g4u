...
class EditCommandPlayer extends Component {
	...
	componentWillReceiveProps(nextProps) {
		...
		} else if (nextProps.players.player !== null && nextProps.players.positions !== null) {
...
export default compose(
	withStyles(styles),
	connect(mapStateToProps, { getCommandPlayer, getPositions, updateCommandPlayer, separatePlayer })
)(EditCommandPlayer);
