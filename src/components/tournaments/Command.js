					...
					<div className={classes.tablesColStat}>
						...
						<MenuItem className={classes.listItemPlayers}>
							...
							<span>
								...
								{+commands.stat.diff > 0 ? `+${commands.stat.diff}` : commands.stat.diff}
								)
							</span>
						</MenuItem>
						<MenuItem className={classes.listItemPlayers}>
			...
			<div className={classes.container}>
				...
				{commands ? (
					<div className={classes.flexDiv}>
						<Avatar alt="" src={commands.info.logo} className={classes.avatar} />
...
export default compose(withStyles(styles), connect(mapStateToProps, { getCommandsInfo }))(Command);
