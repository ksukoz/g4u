...
class CommandsList extends Component {
	...
	// 	this.props.history.push(`/command/${this.props.id}:${commId}`);
	// };

	componentDidMount = () => {
		this.props.getSubCommands(this.props.id);
	};
...
export default compose(withStyles(styles), connect(mapStateToProps, { getSubCommands }))(CommandsList);
